...
$(document).ready(function () {
    ...
    RenderTable('datatable-pasaporteincumplidas', [0, 1, 2, 3, 4, 5, 6, 7,8], null, {
        "paging": true,
        "ordering": false,
        "info": true,
        "searching": true,
...
function CargarTabla(data) {
    ...
    let CitasPasaportImcumplidas = data.objeto;
    Arraycitasglobal = CitasPasaportImcumplidas;
    console.log(CitasPasaportImcumplidas);
    $.each(CitasPasaportImcumplidas, function (index, item) {
        if (item.Fecha != null) {
            let Fecha;
            if (item.Fecha != null) {
