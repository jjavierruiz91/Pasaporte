...
$(document).ready(function () {
    ...
    Get_Data(CargarTabla, '/Admin/AgendaExcepciones/GetListAgendaExcepcionesTramitadas')
...
function CambiarEstado(IdCitaAgendaExcepciones) {
    swal({
        ...
        function (isConfirm) {
            if (isConfirm) {
                swal.close()
                Get_Data(RecargarTabla, '/Admin/AgendaExcepciones/ActualizarEstadoTramitada?IdCitaAgendaExcepciones=' + IdCitaAgendaExcepciones);
            }
            else {
                swal.close()
            }
